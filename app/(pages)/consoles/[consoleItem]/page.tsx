...
const ConsoleItem: React.FC = () => {
  const params = useParams();
  const consoleItem = params.consoleItem;
  const formattedConsoleItem =
    typeof consoleItem === 'string' ? consoleItem.replace(/-/g, ' ') : '';
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      let categoryId = '';
      switch (formattedConsoleItem) {
        case 'playstation consoles':
          categoryId = '67f6d4bf3b3f610de38473d5';
          break;
        case 'xbox consoles':
          categoryId = '67f6d4cf3b3f610de38473d6';
          break;
        case 'nintendo switch':
          categoryId = '67f6d4db3b3f610de38473d7';
          break;
        default:
          return;
      }
  ...
  useEffect(() => {
    ...
    if (colorFilter) {
      updated = updated.filter(
        (item) =>
          item.specifications?.color?.toLowerCase() ===
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          ...
          <Select
            ...
            allowClear
          >
            {[...new Set(products.map((p) => p.specifications?.color))].map(
              (color) =>
                color ? (
